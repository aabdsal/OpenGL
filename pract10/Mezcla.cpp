...
alternar con boton 'n' una variable booleana

enable(fog)

defina color niebla
asignar color niebla
 fog mode, exponencial
fog density
...
// Funcion de atencion al dibujo
{
	...
	glBindTexture(GL_TEXTURE_2D, ventana);
	glDisable(GL_LIGHTING);
	static  Vec3 v0 = {-1,-1,0};
	static  Vec3 v1 = {1,-1,0};
	static  Vec3 v2 = {1,1,0};
	static  Vec3 v3 = {-1,1,0};
