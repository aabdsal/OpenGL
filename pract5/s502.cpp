...
***************************************************/
#define PROYECTO "S5E02::Control del tiempo"
#include <iostream> // Biblioteca de entrada salida
#include <cmath> // Biblioteca matematica de C
#include "../codebase.h" // Biblioteca grafica
using namespace std;
static const float radio = 5.0; 
static float angulo = 0.0; 
static float ojo[] = {0,0,radio}; 
static const float velocidad = 2*3.1415926/60; // Radio de giro de la camara

// Angulo de travelling inicial de la camara
...
// Funcion de atencion al dibujo
{
    ...
    glutSolidTeapot(1.0); // Color de dibujo a azul
    glPopMatrix();
    // Dibuja una tetera en el origen
    ...
    glutSolidTeapot(0.5); 
    glPopMatrix();
    // Color de dibujo a rojo
    // Dibuja una tetera detras
...
// Funcion de atencion al evento idle
{
    ...
    ahora = glutGet(GLUT_ELAPSED_TIME); tiempo_transcurrido= ahora - antes; //Tiempo transcurrido desde el inicio
