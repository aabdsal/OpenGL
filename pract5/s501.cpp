...
***************************************************/
#define PROYECTO "S5E01::Cuadrado rebotante"
...
static GLfloat semiancho, semialto; // Posicion del cuadrado

// Id del cuadrado
// Tamanyo del cuadrado
// Tamaño actual de la ventana del MR
void init()
// Funcion propia de inicializacion
{
    cout << "Version: OpenGL " << glGetString(GL_VERSION) << endl;
    glClearColor(1.0,1.0,1.0,1.0); glColor3f(0,0,0); // Color de fondo a blanco
